...
| HISTAI-Instruct / Polysome | [Paper](https://arxiv.org/abs/2512.17326) [Dataset](https://huggingface.co/datasets/SaltySander/HISTAI-Instruct) [Code](https://github.com/computationalpathologygroup/ANTONI-Alpha) [Pipeline](https://github.com/computationalpathologygroup/Polysome) [Model](https://huggingface.co/SaltySander/ANTONI-Alpha) | Public WSI instruction-tuning dataset generated from HISTAI with Polysome; contains 24,259 WSIs and more than 1.1M instruction-response pairs for training ANTONI-alpha. |
