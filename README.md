...
| HISTAI-Instruct / Polysome | [Paper](https://arxiv.org/abs/2512.17326) [Dataset](https://huggingface.co/datasets/SaltySander/HISTAI-Instruct) [Code](https://github.com/computationalpathologygroup/ANTONI-Alpha) [Pipeline](https://github.com/computationalpathologygroup/Polysome) | Public WSI instruction-tuning dataset generated from HISTAI with Polysome; contains 24,259 WSIs and more than 1.1M instruction-response pairs for training ANTONI-alpha. |
...
| PubMed Central-OA / ARCH | [PMC-OA](https://www.ncbi.nlm.nih.gov/pmc/tools/openftlist/) [ARCH](https://warwick.ac.uk/fac/cross_fac/tia/data/arch) | Public biomedical open-access article and pathology textbook/article image-text source used for pretraining and evaluation in PLIP, CONCH, PathChat, and MUSK. |
...
| BACH | [Dataset](https://zenodo.org/records/3632035) [Hugging Face](https://huggingface.co/datasets/1aurent/BACH) | Public breast cancer histology classification benchmark from the ICIAR 2018 BACH challenge. |
...
| WILDS-CAMELYON17 | [Dataset](https://wilds.stanford.edu/datasets/#camelyon17) [Hugging Face](https://huggingface.co/datasets/wltjr1007/Camelyon17-WILDS) | Public domain-shift benchmark derived from CAMELYON17 lymph-node metastasis slides. |
...
| ISIC SkinCancer / ISIC2020 | [Website](https://www.isic-archive.com/) [Challenge](https://challenge.isic-archive.com/data/#2020) | Public skin lesion imaging benchmark used as a SkinCancer/ISIC external medical-image evaluation source. |
...
| GTEx | [Portal](https://www.gtexportal.org/home/) | Public/request-access genotype-tissue expression resource used as part of TITAN pretraining data. |
...
| TITAN TCGA-Derived Benchmarks | [Code](https://github.com/mahmoodlab/TITAN) [Portal](https://portal.gdc.cancer.gov/) | TCGA-derived public benchmark splits introduced by TITAN, including TCGA-UniformTumor-8K, TCGA-OncoTree, and TCGA-Slide-Reports. |
...
| PanCancer-TCGA | [Dataset](https://zenodo.org/records/5889558) [Portal](https://portal.gdc.cancer.gov/) | Public TCGA-derived pan-cancer patch classification benchmark used in SmartPath-R1 external validation. |
